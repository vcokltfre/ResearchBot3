## This is code from https://github.com/python-discord/sir-lancebot
...
class Emojis:
    pull_request = "<:propen:831940300644941905>"
    pull_request_closed = "<:prclosed:831941473666072577>"
    pull_request_draft = "<:prdraft:83194152858183271>"
    merge = "<:prmerged:831941590363930634>"
    issue = "<:issueopen:831941370796310598>"
    issue_closed = "<:issueclosed:831941422956412989>"
...
class Issues(commands.Cog):
    ...
    async def fetch_issues(
        ...
        # to get the desired information for the PR.
            ...
            async with self.session.get(pulls_url) as p:
